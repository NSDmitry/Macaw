...
open class Shape: MacawNode {
    ...
    public init(form: Locus, fill: Fill? = nil, stroke: Stroke? = nil, place: Transform = Transform.identity, opaque: Bool = true, opacity: Double = 1, clip: Locus? = nil, mask: MacawNode? = nil, effect: Effect? = nil, visible: Bool = true, tag: [String] = []) {
